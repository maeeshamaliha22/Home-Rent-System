...
{
    public partial class Adabar1 : Form
    {
        ...
        private void Adabar1_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            Table_Adabar s = ul.Table_Adabars.SingleOrDefault(x => x.Area == "1");
            if (s != null)
            {
        ...
        private void Adabar1_Load(object sender, EventArgs e)
        {
            pictureBox1.Hide();
            pictureBox2.Hide();
        }
