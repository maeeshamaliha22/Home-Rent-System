...
{
    public partial class Mirpur3 : Form
    {
        ...
        private void Mirpur3_Load(object sender, EventArgs e)
        {
            pictureBox1.Hide();
            pictureBox2.Hide();
        }

        private void Mirpur3_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            Table_Mirpur s = ul.Table_Mirpurs.SingleOrDefault(x => x.Area == "3");
            if (s != null)
            {
