...
{
    public partial class Adabar3 : Form
    {
        ...
        private void Adabar3_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            Table_Adabar s = ul.Table_Adabars.SingleOrDefault(x => x.Area == "3");
            if (s != null)
            {
        ...
        private void Adabar3_Load(object sender, EventArgs e)
        {
            pictureBox1.Hide();
            pictureBox2.Hide();
        }
