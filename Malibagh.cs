...
{
    public partial class Malibagh : Form
    {
        ...
        private void Malibagh1_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void buttonPlaceRent_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("insert into Table_Malibagh(BedRooms,Address,Size,RentAmount,Image1,Image2,Area) values(@bedrooms,@address,@size,@rent_amount,@images1,@images2,@area)", con);
                con.Open();
