...
{
    public partial class Mirpur2 : Form
    {
        ...
        private void Mirpur2_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            Table_Mirpur s = ul.Table_Mirpurs.SingleOrDefault(x => x.Area == "2");
            if (s != null)
            {
        ...
        private void Mirpur2_Load(object sender, EventArgs e)
        {
            pictureBox1.Hide();
            pictureBox2.Hide();
        }
