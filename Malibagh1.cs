...
{
    public partial class Malibagh1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            Table_Malibagh s = ul.Table_Malibaghs.SingleOrDefault(x => x.Area == "1");
            if (s != null)
            {
        ...
        private void Malibagh1_Load(object sender, EventArgs e)
        {
            pictureBox1.Hide();
            pictureBox2.Hide();
        }
