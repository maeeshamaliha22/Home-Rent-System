    ...
    public partial class Mirpur : Form
    {
        ...
        private void buttonPlaceRent_Click(object sender, EventArgs e)
        {
            ...
            if (textBoxBedrooms.Text != "" && textBoxAddress.Text != "" && textBoxSize.Text != "" && textBoxRentAmount.Text != "")
            {
                ...
                cmd = new SqlCommand("insert into Table_Mirpur(BedRooms,Address,Size,RentAmount,Image1,Image2,Area) values(@bedrooms,@address,@size,@rent_amount,@images1,@images2,@area)", con);
                con.Open();
